...
package local_project_demo.restapidemo_0_1;
...
/**
 * Job: RestAPIDemo Purpose: Creating REST API endpoints<br>
 * Description: Creating REST API endpoints <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class RestAPIDemo implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "RestAPIDemo.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(RestAPIDemo.class);
	...
	private final String jobName = "RestAPIDemo";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(RestAPIDemo.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_DEMO_RestAPIDemo = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_DEMO_RestAPIDemo = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_DEMO_RestAPIDemo.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_DEMO_RestAPIDemo.length == 0) {
						commonByteArray_LOCAL_PROJECT_DEMO_RestAPIDemo = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_DEMO_RestAPIDemo = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_DEMO_RestAPIDemo, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_DEMO_RestAPIDemo, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_DEMO_RestAPIDemo, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_DEMO_RestAPIDemo, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_DEMO_RestAPIDemo) {
	...
	public static class json_postStruct implements routines.system.IPersistableRow<json_postStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_DEMO_RestAPIDemo = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_DEMO_RestAPIDemo = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(json_postStruct other) {
	...
	public void tFixedFlowInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				json_postStruct json_post = new json_postStruct();
...
// # Outputs initialization
				json_postStruct json_post_tmp = new json_postStruct();
				json_postStruct json_post_save = null;
//the aggregate variable
				json_postStruct json_post_aggregate = null;
				int count_json_post_tXMLMap_1_TXMLMAP_OUT = 0;
...
// ###############################
				...
				class GenerateDocument_json_post {
					...
					public GenerateDocument_json_post() {
...
// build root xml tree 
						if (needRoot) {
							...
							root_0 = root.addElement("first_name");
							valueMap.put("root_0", row1.first_name);
							...
							root_1 = root.addElement("last_name");
							valueMap.put("root_1", row1.last_name);
				...
				GenerateDocument_json_post gen_Doc_json_post_tXMLMap_1_TXMLMAP_OUT = new GenerateDocument_json_post();
				boolean docAlreadyInstanciate_json_post = false;
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					row1.first_name = "Nicholas";

					row1.last_name = "Schulz";
...
// # Output table : 'json_post'
						count_json_post_tXMLMap_1_TXMLMAP_OUT++;

						if (!docAlreadyInstanciate_json_post) {
							docAlreadyInstanciate_json_post = true;
							gen_Doc_json_post_tXMLMap_1_TXMLMAP_OUT = new GenerateDocument_json_post();
//init one new out struct for cache the result.
							json_post_aggregate = new json_postStruct();
							json_post_aggregate.body = new routines.system.Document();
							json_post_aggregate.body.setDocument(gen_Doc_json_post_tXMLMap_1_TXMLMAP_OUT.getDocument());

//construct the resultset
							allOutsForAggregate_tXMLMap_1.add(json_post_aggregate);
						}

						gen_Doc_json_post_tXMLMap_1_TXMLMAP_OUT
								.generateElements(rejectedDocInnerJoin_tXMLMap_1_TXMLMAP_OUT, row1, Var);

						json_post_tmp.string = null;
						log.debug("tXMLMap_1 - Outputting the record " + count_json_post_tXMLMap_1_TXMLMAP_OUT
								+ " of the output table 'json_post'.");

						if (json_post_aggregate != null) {

							json_post_aggregate.string = json_post_tmp.string;
						}
// ###############################
				...
				log.debug("tXMLMap_1 - Written records count in the table 'json_post': "
						+ count_json_post_tXMLMap_1_TXMLMAP_OUT + ".");
				...
				util_tLogRow_2.setTableName("Response");
...
///////////////////////    			
				...
				util_tLogRow_1.setTableName("Error");
				util_tLogRow_1.addRow(new String[] { "errorCode", "errorMessage", });
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "json_post");
				}
				...
				for (Object row_out_tXMLMap_1_TXMLMAP_IN : outs_tXMLMap_1) {// TD512
					...
					if (row_out_tXMLMap_1_TXMLMAP_IN != null
							&& row_out_tXMLMap_1_TXMLMAP_IN instanceof json_postStruct) {
						json_post = (json_postStruct) row_out_tXMLMap_1_TXMLMAP_IN;
						routines.system.NestXMLTool.generateOk(json_post.body, false);
					}
...
// Start of branch "json_post"
					if (json_post != null) {
						...
						if (log.isTraceEnabled()) {
							log.trace("json_post - " + (json_post == null ? "" : json_post.toLogString()));
						}
...
// expected response body
						...
						try {
							...
							if (null != json_post.body) {
								requestDoc_tRESTClient_1 = json_post.body.getDocument();
							}
							requestString_tRESTClient_1 = json_post.string;
							...
							String url = "https://api.predic8.de:443/shop/customers/";
							// {baseUri}tRESTClient
							...
							try {
								...
								row3.errorCode = ex_tRESTClient_1.getResponse().getStatus();
								...
								row3.errorMessage = errorMessage_tRESTClient_1;
...
///////////////////////		
							...
							if (row2.statusCode != null) { //
								row_tLogRow_2[0] = String.valueOf(row2.statusCode);

							} //

							if (row2.body != null) { //
								row_tLogRow_2[1] = String.valueOf(row2.body);

							} //

							if (row2.string != null) { //
								row_tLogRow_2[2] = String.valueOf(row2.string);
...
///////////////////////		
							...
							if (row3.errorCode != null) { //
								row_tLogRow_1[0] = String.valueOf(row3.errorCode);

							} //

							if (row3.errorMessage != null) { //
								row_tLogRow_1[1] = String.valueOf(row3.errorMessage);
...
// [tRESTCliend_end]
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "json_post");
				}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final RestAPIDemo RestAPIDemoClass = new RestAPIDemo();

		int exitCode = RestAPIDemoClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'RestAPIDemo' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'RestAPIDemo' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = RestAPIDemo.class.getClassLoader()
					.getResourceAsStream("local_project_demo/restapidemo_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = RestAPIDemo.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : RestAPIDemo");
		}
...
/************************************************************************************************
 * 99327 characters generated by Talend Open Studio for Data Integration on the
 * 15 June 2022 at 09:09:14 EAT
 ************************************************************************************************/