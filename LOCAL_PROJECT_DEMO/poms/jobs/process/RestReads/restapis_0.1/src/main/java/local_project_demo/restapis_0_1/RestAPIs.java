...
package local_project_demo.restapis_0_1;
...
/**
 * Job: RestAPIs Purpose: Getting data from a Rest API<br>
 ...
 * @status
 */
public class RestAPIs implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "RestAPIs.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(RestAPIs.class);
	...
	private final String jobName = "RestAPIs";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(RestAPIs.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String apikey = "api-key=Vs34XmCX43HAFEfPf6d1XPfY35GQO7Aa&";
				String secret = "secret-key=GSlzkN5GAlWXkZ94";

				context.url = host + apikey + secret;
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_DEMO_RestAPIs = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_DEMO_RestAPIs = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_DEMO_RestAPIs.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_DEMO_RestAPIs.length == 0) {
						commonByteArray_LOCAL_PROJECT_DEMO_RestAPIs = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_DEMO_RestAPIs = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_DEMO_RestAPIs, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_DEMO_RestAPIs, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_DEMO_RestAPIs, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_DEMO_RestAPIs, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_DEMO_RestAPIs) {
...
///////////////////////    			
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tExtractJSONFields_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tExtractJSONFields_1.append(" | ");
							log4jParamters_tExtractJSONFields_1.append(
									"MAPPING_4_JSONPATH" + " = " + "[{QUERY=" + ("\"rank\"") + ", SCHEMA_COLUMN="
											+ ("rank") + "}, {QUERY=" + ("\"title\"") + ", SCHEMA_COLUMN=" + ("title")
											+ "}, {QUERY=" + ("\"author\"") + ", SCHEMA_COLUMN=" + ("author")
											+ "}, {QUERY=" + ("\"price\"") + ", SCHEMA_COLUMN=" + ("price") + "}]");
							log4jParamters_tExtractJSONFields_1.append(" | ");
				...
				if (row1.Body != null) {// C_01
					...
					String loopPath_tExtractJSONFields_1 = "$.results.books[*]";
					...
					for (int i_tExtractJSONFields_1 = 0; isStructError_tExtractJSONFields_1
						...
						if (!isStructError_tExtractJSONFields_1) {
							...
							try {
								jsonPath_tExtractJSONFields_1 = "rank";
								...
								try {
									...
									if (value_tExtractJSONFields_1 != null
										...
										row2.rank = ParserUtils.parseTo_Integer(value_tExtractJSONFields_1.toString());
									} else {
										row2.rank =
								...
								jsonPath_tExtractJSONFields_1 = "author";
								compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1
										.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
								...
								try {
									...
									row2.author = value_tExtractJSONFields_1 == null ?
								...
								jsonPath_tExtractJSONFields_1 = "price";
								compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1
										.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
								...
								try {
									...
									row2.price = value_tExtractJSONFields_1 == null ?
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final RestAPIs RestAPIsClass = new RestAPIs();

		int exitCode = RestAPIsClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'RestAPIs' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'RestAPIs' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = RestAPIs.class.getClassLoader()
					.getResourceAsStream("local_project_demo/restapis_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = RestAPIs.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : RestAPIs");
		}
...
/************************************************************************************************
 * 86896 characters generated by Talend Open Studio for Data Integration on the
 * 14 June 2022 at 15:09:11 EAT
 ************************************************************************************************/